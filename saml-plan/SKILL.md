...
description: >
  ...
  This **NEVER** triggers implementation directly or indirectly. Outcome of this skill should be `./.plan.md` only. It should **NOT** modify any other file.
...
- Write a self-contained implementation plan to the plan file: `./.plan.md`.
...
- Tell the user: **"✅ Plan written. Please review `./.plan.md`. Let me know when you're happy with it
...
- Stop here. Do not trigger implementation or any other action, even if you're on autopilot mode. The user must explicitly ask for implementation via `saml-implement` after they're satisfied with the plan.
